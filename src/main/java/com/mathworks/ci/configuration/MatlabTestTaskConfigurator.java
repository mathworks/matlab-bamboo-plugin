...
public class MatlabTestTaskConfigurator extends MatlabTaskConfigurator {
    ...
    public Map < String, String > generateTaskConfigMap(@NotNull final ActionParametersMap params, @Nullable final TaskDefinition previousTaskDefinition) {
        ...
        config.put(MatlabBuilderConstants.HTML_MODEL_FOLDER , params.getString(MatlabBuilderConstants.HTML_MODEL_FOLDER ));
    ...
    public void populateContextForCreate(@NotNull final Map < String, Object > context) {
        ...
        context.put(MatlabBuilderConstants.HTML_MODEL_FOLDER, MatlabBuilderConstants.HTML_MODEL_DEFAULT_DIR);
    }
    ...
    public void populateContextForEdit(@NotNull final Map < String, Object > context, @NotNull final TaskDefinition taskDefinition) {
        ...
        context.put(MatlabBuilderConstants.HTML_MODEL_FOLDER, taskDefinition.getConfiguration().get(MatlabBuilderConstants.HTML_MODEL_FOLDER));
    ...
    public void validate(@NotNull final ActionParametersMap params, @NotNull final ErrorCollection errorCollection) {
        ...
        if (params.getBoolean(MatlabBuilderConstants.JUNIT_RESULTS_CHX) && (StringUtils.isBlank(params.getString(MatlabBuilderConstants.JUNIT_FILE)))) {
            errorCollection.addError(MatlabBuilderConstants.JUNIT_FILE, "Specify a valid location for the JUnit test results.");
        }
        if (params.getBoolean(MatlabBuilderConstants.STM_RESULTS_CHX) && (StringUtils.isBlank(params.getString(MatlabBuilderConstants.STM_FILE)))) {
            errorCollection.addError(MatlabBuilderConstants.STM_FILE, "Specify a valid location for the Simulink Test Manager test results.");
        }
        ...
        if (params.getBoolean(MatlabBuilderConstants.HTML_MODELCOV_CHX) && (StringUtils.isBlank(params.getString(MatlabBuilderConstants.HTML_MODEL_FOLDER)))) {
            errorCollection.addError(MatlabBuilderConstants.HTML_MODEL_FOLDER, "Specify a valid location for the HTML model coverage report.");
        }
